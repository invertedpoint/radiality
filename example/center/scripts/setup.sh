...
wget -P /tmp https://bitbucket.org/pypy/pypy/downloads/pypy3-2.4.0-linux64.tar.bz2
mkdir /subsystem/pypy
tar xvjf /tmp/pypy3-2.4.0-linux64.tar.bz2 -C /subsystem/pypy --strip-components 1
rm /tmp/pypy3-2.4.0-linux64.tar.bz2
# Installing `pip3` for the `PyPy + Py3K`
wget -P /tmp https://bootstrap.pypa.io/3.2/get-pip.py
